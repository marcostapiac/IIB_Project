...
def path_simulation(t1=0.0, t2=10.0, num_obs=100, num_epochs=2000, subordinator_truncation=0.0, nu=2.0, gamma=1.0, nProcesses=10):
    ...
    title = "Sample Gamma Paths with $\\nu, \\gamma = " + str(nu) + " ," + str(gamma) + " $ at time $t = 1$"
