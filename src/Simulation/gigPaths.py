...
def path_simulation(t1=0.0, t2=10.0, num_obs=100, num_epochs=2000, subordinator_truncation=0.0, delta=0.1, gamma=1.0,
    ...
    title = "Sample GIG Paths with $\\delta, \\gamma, \\lambda = " + str(delta) + " ," + str(gamma) + " ," + str(
        lambd) + " ," + "$ at time $t = 1.0$"
